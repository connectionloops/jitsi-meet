...
/**
 * Signals that the configuration (commonly known in Cloops Meet as config.js)
...
/**
 * Signals that a configuration (commonly known in Cloops Meet as config.js)
...
/**
 * Stores a specific Cloops Meet config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Cloops Meet config.js to store.
 * @returns {Function}
 */
