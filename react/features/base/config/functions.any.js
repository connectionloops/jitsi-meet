...
/**
 * Restores a Cloops Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Cloops Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Cloops Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
