...
/**
 * Restores a TWA Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The TWA Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "TWA Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
