...
/**
 * The react-native side of TWA Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by TWA Meet to
     *        a conference call.
     * @param handle - a call handle which by default is TWA Meet room's URL.
