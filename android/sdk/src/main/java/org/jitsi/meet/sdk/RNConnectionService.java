...
/**
 * The react-native side of Cloops Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Cloops Meet to
     *        a conference call.
     * @param handle - a call handle which by default is Cloops Meet room's URL.
